...
/* harmony import */ var _src_js_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../src/js/index */ "./src/js/index.js");
...
window.addEventListener("load", function () {
  var mainItems = document.querySelectorAll(".su-main-nav li");
  mainItems.forEach(function (item) {
    if (item.classList.contains("active")) {
      item.classList.add("su-main-nav__item--current");
    }
  });
  var secItems = document.querySelectorAll(".su-secondary-nav__menu li a");
